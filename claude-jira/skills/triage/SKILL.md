---
name: triage
description: Interactively triage Jira issues that are missing priority, labels, estimate, or type. Use this skill only for /triage or when the user explicitly asks to triage issues. Do not trigger proactively.
---
