...
A structured pause protocol for Claude Code. When invoked, Claude Code stops all forward momentum and performs a honest self-audit before deciding whether to continue, correct course, or ask for clarification.
